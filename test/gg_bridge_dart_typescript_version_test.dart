...
// lib/src/gg_bridge_dart_typescript_version.dart
// when it drifts from pubspec.yaml. Drift is not an error here: the literal
// is rewritten and the test passes.

void main() {
  group('gg_bridge_dart_typescript_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      const declaration = 'const String ggBridgeDartTypescriptVersion = ';
      final match = RegExp(
        r'^version:\s*(\S+)\s*$',
        multiLine: true,
      ...
      final file = File('lib/src/gg_bridge_dart_typescript_version.dart');
